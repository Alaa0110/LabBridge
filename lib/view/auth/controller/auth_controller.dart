...
class AuthController extends GetxController {
  ...
  Future<void> logout() async {
    try {
      ...
      final response = await crud.getData(AppLink.logout, AppLink().getHeaderToken());
      ...
      response.fold(
          ...
          Get.snackbar("خطأ", "فشل تسجيل الخروج، حاول مرة أخرى");
            ...
            (data) async {
          // Clear token and reset state properly
          MyServices myServices = Get.find();
          await myServices.sharedPreferences.remove(SharedPreferencesKeys.tokenKey);
          ConstData.token = '';
