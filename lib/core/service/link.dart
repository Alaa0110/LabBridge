...
//technicals
  static String getTechnicals = "$serverApiRoot/admin/get-technicals";
  static String technicalsAvailability = "$serverApiRoot/admin/availability";
  //order
  static String createOrder = "$serverApiRoot/admin/orders";
  static String getOrder = "$serverApiRoot/admin/orders";
  static String fromToOrders = "$serverApiRoot/admin/from-to-orders";
  static String getOrdersByStatus = "$serverApiRoot/admin/listOrdersByStatus";

//bills
  static String addType = "$serverApiRoot/admin/types";
  static String updateType = "$serverApiRoot/admin/types";
  static String getType = "$serverApiRoot/admin/types";
